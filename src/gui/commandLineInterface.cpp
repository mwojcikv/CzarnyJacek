...
//                botButtonTexts[i].setPosition(270, float(100 + i * 70));
//
...
//                multiplayerButtons[i].setPosition(250, float(100 + i * 70));
//
...
//                multiplayerButtonTexts[i].setPosition(270, float(100 + i * 70));
//
...
//                shopButtons[i].setPosition(250, float(100 + i * 70));
//
...
//                shopButtonTexts[i].setPosition(270, float(100 + i * 70));
//
